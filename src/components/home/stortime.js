...
export default function StoreTimings() {
  return (
    <section
      className="relative bg-[url('/images/background1.png')] bg-cover bg-center bg-fixed py-10 md:py-28"
    >
      ...
      <div className="relative max-w-6xl mx-auto px-6 md:px-10 z-10">
        <motion.div
          ...
          viewport={{ once: true }}
          className="grid md:grid-cols-2 gap-10 bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.15)] p-5 md:p-14"
        >
      ...
      viewport={{ once: true }}
      className="bg-white/10 border border-white/20 backdrop-blur-xl rounded-2xl p-2 md:p-8 text-center md:text-left shadow-inner"
    >
